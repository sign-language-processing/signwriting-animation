...
# Add matplotlib.use() stub to prevent AttributeError
stub_mpl.use = _noop

# minimal set of functions used in on_fit_end and plotting
...
stub_plt.subplots = lambda *a, **k: (None, [[None, None], [None, None]])
stub_plt.switch_backend = _noop
